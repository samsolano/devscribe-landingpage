...
// Welcome email
app.post("/api/resend", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, name, resend, _yield$resend$emails$, data, error;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, email = _req$body.email, name = _req$body.name; // Expecting JSON payload { "email": "user@example.com", "name": "alice" }
          if (email) {
            _context.next = 4;
            break;
          }
